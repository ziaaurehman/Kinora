    ...
    <div className="min-h-[calc(100vh-72px)] bg-bg-cream flex flex-col items-center justify-center p-6 py-12">
      <div className="w-full max-w-[500px] bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-border">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="font-sans text-3xl font-bold text-txt-primary tracking-tight">Sign up</h1>
        ...
        <form onSubmit={handleCreateAccount} className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2.5 mt-2">
            <div className="relative flex items-center justify-center">
              <input type="checkbox" className="peer appearance-none w-[18px] h-[18px] border border-chat-muted rounded-[4px] checked:bg-txt-primary checked:border-txt-primary cursor-pointer transition-colors" />
            ...
            <p className="font-sans text-[14px] text-chat-dark">
              I've read and agree with <Link href="#" className="text-[#D96C3B] hover:underline">Terms of Service</Link> and <Link href="#" className="text-[#D96C3B] hover:underline">Privacy Policy.</Link>
            </p>
          </div>

          {/* Submit */}
          <button type="submit" className="w-full h-[46px] bg-[#112330] text-white rounded-lg font-sans font-medium text-[15px] mt-2 hover:bg-opacity-90 transition-all">
            Create account
          </button>
        </form>
