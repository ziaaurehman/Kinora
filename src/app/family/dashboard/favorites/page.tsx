...
const favorites = [
  { id: 1, name: 'Caregiver agency', date: 'Apr 11, 2025', avatar: '/avatar.png' },
  { id: 2, name: 'Caregiver agency', date: 'Apr 11, 2025', avatar: '/avatar.png' },
  { id: 3, name: 'Caregiver agency', date: 'Apr 11, 2025', avatar: '/avatar.png' },
  { id: 4, name: 'Caregiver agency', date: 'Apr 11, 2025', avatar: '/avatar.png' },
  { id: 5, name: 'Caregiver agency', date: 'Apr 11, 2025', avatar: '/avatar.png' },
];

export default function FavoritedAgenciesPage() {
    ...
    <div className="bg-bg-section min-h-screen pt-12 pb-24 px-4 sm:px-6 font-sans">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="flex items-start gap-5 mb-10">
          ...
          <div>
            <h1 className="text-[32px] font-bold text-primary tracking-tight leading-none mb-2">Favorited Agencies</h1>
            <p className="text-[16px] text-[#8C9BA5]">Quick access to agencies you&apos;ve saved for future care.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-border overflow-hidden">
           ...
           <div className="px-8 py-6 border-b border-border">
             <h2 className="text-[24px] font-bold text-primary">Favorited Agencies List</h2>
           </div>
           ...
           <div className="px-8 py-4 border-b border-gray-100 flex items-center justify-between text-[14.5px] font-medium text-[#8C9BA5]">
             ...
             <span className="mr-[50px]">Actions</span>
           </div>
           ...
           <div className="flex flex-col">
             {favorites.map((item, index) => (
               <React.Fragment key={item.id}>
                 <div className="px-8 py-5 flex items-center justify-between group hover:bg-gray-50 transition-colors relative action-menu-container">
                   ...
                   <div className="flex items-center gap-4">
                     <button className="px-6 py-2.5 bg-[#122A38] text-white text-[14px] font-medium rounded-lg hover:bg-primary transition-colors">
                       Submit Query
                     </button>
                     <button 
                       className="w-8 h-8 flex items-center justify-center text-[#8C9BA5] hover:text-primary transition-colors focus:outline-none"
                     ...
                     {openMenuId === item.id && (
                        <div 
                          className="absolute right-8 top-[60px] bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 px-6 py-3 z-10"
                          onClick={(e) => e.stopPropagation()}
                        >
                          <button 
                            className="text-[15px] font-medium text-primary hover:text-red-500 transition-colors w-full text-left"
                            onClick={() => {
                 ...
                 {index < favorites.length - 1 && <div className="h-[1px] bg-gray-100 mx-8"></div>}
               </React.Fragment>
             ))}
           </div>
